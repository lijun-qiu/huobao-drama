...
export const FLUX_TRANSLATE_GLOSSARY_LINES = [
  ...
  '日系2D动漫 / 日系2D / Anime Style → Japanese 2D anime illustration',
  '高对比电影光影 / 戏剧光影 → high-contrast cinematic lighting',
  '冷蓝紫 → cool blue-purple night tones',
  '三维国漫 / 3D国漫 / 三维国漫电影感 → Chinese 3D donghua CGI, stylized toon-shaded',
  '强轮廓逆光 / 轮廓光 / rim light → dramatic cyan rim light',
  '光滑CGI皮肤 → smooth CGI skin',
  '赛璐璐 → cel shading',
